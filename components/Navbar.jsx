    ...
    <header className="bg-gray-900">
      <div className="max-w-[80rem] mx-auto flex justify-between items-center">
        <div className="flex gap-3 p-3">
          <Link href="https://www.google.com/maps/dir//El-Big+Reviews/data=!4m6!4m5!1m1!4e2!1m2!1m1!1s0x47112984b496b8a3:0xa78092697a8adc33?sa=X&ved=2ahUKEwjJiaKo6IeEAxVcSPEDHYpQBmcQ9Rd6BAg8EAA&hl=en-PL" className="flex items-center gap-2">
          <FaLocationDot className="text-red-500"/>
            <span className="hidden lg:block hover:text-gray-400 transition-colors duration-200">ul. Nakielska 42/44</span>
            </Link>
          <Link href="mailto:biuro@elbig.com.pl" className="flex items-center gap-2">
          <MdEmail className="text-red-500"/>
            <span className="hidden lg:block hover:text-gray-400 transition-colors duration-200">biuro@elbig.com.pl</span>
            </Link>
          <Link href="tel:+48324500640" className="flex items-center gap-2">
